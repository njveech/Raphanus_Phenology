...
# Julia response: Again, you nailed it despite your doubts! It may seem weird, but we basically want to turn the start and end-mo columns into a ridiculously redundant columns so we can use them in the following step to specify which rows to keep based on a value present in each row. We can chat through all of this tomorrow on zoom if I am still not making sense!
